import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as s,a as i}from"./app-HXmC235x.js";const a={},l=i(`<h1 id="《redis》" tabindex="-1"><a class="header-anchor" href="#《redis》" aria-hidden="true">#</a> 《Redis》</h1><pre><code>    Redis，是一种以K,V形式存储并基于内存的非关系型数据库。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h2 id="redis之rdb" tabindex="-1"><a class="header-anchor" href="#redis之rdb" aria-hidden="true">#</a> Redis之RDB</h2><p>RDB全称“Redis Database”，在指定的时间间隔将内存中的数据快照存入磁盘，恢复时便是将硬盘中的快照信息读到内存中。</p><blockquote><p>备份创建过程</p></blockquote><p>Redis会单独创建(Fork)一个子进程来进行持久化，首先将数据写入到一个临时文件，等持久化这个过程结束后，再用临时文件替换上次持久化完成的文件。在整个过程中，主进程是不进行任何IO操作的。</p><blockquote><p>Fork</p></blockquote><p>“Fork”是复制一个和当前进程相同的进程，作为原进程的子进程。 出于安全考虑，Linux引入“<mark>写时复制技术</mark>” 一般情况下，主进程和子进程会共用同一块内存，只有进程空间的各段的内容要发生变化，才会将父进程的内容复制一份给子进程。</p><blockquote><p>redis.conf</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>repl-disable-tcp-nodelay no
...
<span class="token comment">#注意修改这里的配置，yes开启持久化，no关闭持久化</span>
appendonly <span class="token function">yes</span>

appendfilename <span class="token string">&quot;appendonly.aof&quot;</span>
appendfsync everysec <span class="token comment"># always:立即记录 ; everysec:先存入AOF缓冲区，每隔1s将缓冲区命令写入aof文件 ; no : 先存入缓冲区，由操作系统决定何时将内容写入磁盘</span>
no-appendfsync-on-rewrite no
auto-aof-rewrite-percentage <span class="token number">100</span> <span class="token comment"># 比上次文件增长百分比 触发 bgrewriteaof</span>
auto-aof-rewrite-min-size 64mb <span class="token comment"># 当文件体积达到 64mb执行</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,17),d=[l];function r(t,c){return n(),s("div",null,d)}const m=e(a,[["render",r],["__file","redis.html.vue"]]);export{m as default};
