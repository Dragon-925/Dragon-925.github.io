import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as d,a as n}from"./app-fZFl21or.js";const l={},s=n(`<h1 id="《redis》" tabindex="-1"><a class="header-anchor" href="#《redis》" aria-hidden="true">#</a> 《Redis》</h1><pre><code>    Redis，是一种以K,V形式存储并基于内存的非关系型数据库。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul>`,9),a=[s];function r(t,c){return i(),d("div",null,a)}const m=e(l,[["render",r],["__file","redis.html.vue"]]);export{m as default};
